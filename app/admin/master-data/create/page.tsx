...
export default function CreateMasterDataPage() {
  ...
  const [form, setForm] = useState<Omit<MasterData, 'id' | 'updatedAt' | 'updatedBy'>>({
    name: '',
    description: '',
    status: 'active',
    options: [],
    ...
    <AdminLayout>
      <div className="p-6 max-w-4xl">
        ...
        <div className="mb-4 flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-600">Add Master</span>
        </div>

        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Add Master</h1>
            <p className="text-gray-500 text-sm mt-1">Create a new master option set</p>
          </div>
          <Link
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500">Fill in the details for this master option set</p>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-mono focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                          placeholder={`option-${idx + 1}`}
                        />
                      </div>
                    </div>
